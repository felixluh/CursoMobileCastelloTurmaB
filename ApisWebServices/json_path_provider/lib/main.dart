import 'dart:convert';
import 'dart:io'; // biblioteca pra acessar os arquivos do dispositivos moveis
...
class _ProdutoPageState extends State<ProdutoPage> {
  ...
  //carregar as informações no inicio do aplicativo
  @override
  void initState() {
    super.initState();
    _carregarProdutos();
  ...
  Future<File> _getArquivo() async {
    ...
    return File("${dir.path}/prutos.json");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Cadastro de Proutos")),
      body: Padding(
