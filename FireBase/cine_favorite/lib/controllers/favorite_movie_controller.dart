...
import 'package:path_provider/path_provider.dart';class FavoriteMovieController {
  //atributos
...
Stream<List<FavoriteMovie>> getFavoriteMovies(){
  ...
  if(currentUser==null)return Stream.value([]); //retorna alista vazia caso nção tenha usuário
